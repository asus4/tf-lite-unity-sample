...
namespace TensorFlowLite
{
        ...
        where T : struct
    {
        ...
        public BaseImagePredictor(string modelPath, Accelerator accelerator, int inputImageIndex = 0)
        {
            ...
            // Initialize inputs
            {
                var inputShape0 = interpreter.GetInputTensorInfo(inputImageIndex).shape;
